...
export default function Card({ listingsData, updateDetails}) {
    ...
    return(
        ...
        <div className="max-w-2xl mx-auto shadow hover:shadow-lg ">
            <div className="bg-white shadow-md rounded-lg max-w-sm bg-sky-100 dark:border-gray-700 ">
                <figure className="px-5 pb-5 ">
                    ...
                    <figcaption>
                    <h4 className="text-3xl font-bold text-cyan-900 dark:text-cyan-900py-2">{listingsData.offer.price}</h4>
                        <h2 className="text-cyan-900 font-semibold text-xl tracking-tight dark:text-cyan-900 py-5">{listingsData.product_title}</h2>
